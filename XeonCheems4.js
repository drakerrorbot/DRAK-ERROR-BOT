...
//© 2022 DRAK Bot Inc. DRAK ERROR Bot MD
//Thank you to Lord DRAK, Family and Myself
//════════════════════════════//
      // DRAK TEAM
//════════════════════════════//
...
await XeonBotInc.sendMessage(from, {  text: msg , footer: `✫ ✫ ⚜ 𝙳𝚁𝙰𝙺 𝙴𝚁𝚁𝙾𝚁 ☊⚚ ✫ ✫` , buttons: buttons , headerType: 4} , { quoted: m } )  
...
case 'alive': {
    ...
    ☛☊ making Mr.Hansamala & Mr.Suraj & Mr.Tharuwa⚚
...
case 'menu': {
    ...
    let buttonMessage = {
    image: { url: 'https://i.ibb.co/xjDHhtt/lv-0-20220918155017-unscreen.gif` },
    caption: `╔═══════✪「 OWNER 」	
    ╠●  ${prefix}self
    ╠●  ${prefix}public
    ╠●  ${prefix}antitag
